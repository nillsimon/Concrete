                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(ManagerActivity.this,"Вы успешно вошли "+"\n" + "с адресом: "
                                        + textInputEmail.getEditText().getText().toString().trim()  + "\n" +"c именем: "
                                ...
                                Toast.makeText(ManagerActivity.this, "Authentication failed.",
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                authBar.setVisibility(ProgressBar.INVISIBLE);
                                startActivity(new Intent(ManagerActivity.this, MapsActivity.class));

                                Toast.makeText(ManagerActivity.this,"Вы успешно зарегистрированы "+"\n" + "с адресом: "
                                        + textInputEmail.getEditText().getText().toString().trim()  + "\n" +"c именем: "
                                        + textInputName.getEditText().getText().toString().trim() + "\n"+"и паролем: "
                                        + textInputPassword.getEditText().getText().toString().trim(), Toast.LENGTH_LONG).show();
                                ...
                                // If sign in fails, display a message to the user.
                                Log.w(TAG, "createUserWithEmail:failure", task.getException());
                                Toast.makeText(ManagerActivity.this, "Такой пользователь уже зарегистрирован",
                                        Toast.LENGTH_SHORT).show();
                                // updateUI(null);
                            }
