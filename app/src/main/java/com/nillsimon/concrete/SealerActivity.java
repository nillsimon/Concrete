...
public class SealerActivity extends AppCompatActivity implements View.OnClickListener {
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(SealerActivity.this, "Вы успешно вошли " + "\n" + "с адресом: "
                                        + textInputEmail.getEditText().getText().toString().trim() + "\n" + "c именем: "
                                ...
                                Toast.makeText(SealerActivity.this, "Authentication failed.",
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                authBar.setVisibility(ProgressBar.INVISIBLE);
                                startActivity(new Intent(SealerActivity.this, MapsActivity.class));


                                Toast.makeText(SealerActivity.this, "Вы успешно зарегистрированы " + "\n" + "с адресом: "
                                        + textInputEmail.getEditText().getText().toString().trim() + "\n" + "c именем: "
                                        + textInputName.getEditText().getText().toString().trim() + "\n" + "и паролем: "
                                        + textInputPassword.getEditText().getText().toString().trim(), Toast.LENGTH_LONG).show();
                                ...
                                // If sign in fails, display a message to the user.
                                Log.w(TAG, "createUserWithEmail:failure", task.getException());
                                Toast.makeText(SealerActivity.this, "Такой пользователь уже зарегистрирован",
                                        Toast.LENGTH_SHORT).show();
                                // updateUI(null);
                            }
